...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Receipt',
          path: '/receipt',
          builder: (context, params) => const ReceiptWidget(),
        ),
        FFRoute(
          name: 'Dashboard',
          path: '/dashboard',
        ...
        FFRoute(
          ...
          path: '/qrScan',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'QrScan')
              : const QrScanWidget(),
        ),
        FFRoute(
          name: 'Transfer',
        ...
        FFRoute(
          ...
          builder: (context, params) => const CompleteUserRegistrationWidget(),
        ),
        FFRoute(
          name: 'AddCardPage',
          path: '/addCardPage',
          builder: (context, params) => const AddCardPageWidget(),
        ),
        FFRoute(
          name: 'ProfileEdit',
          path: '/profileEdit',
